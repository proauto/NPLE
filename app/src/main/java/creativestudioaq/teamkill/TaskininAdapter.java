 ...
 */
public class TaskininAdapter extends BaseAdapter {

    private LayoutInflater _inflater;
    private static ArrayList<TaskininList> _lists;
    private int _layout;
    private static Context m_ctx;


    TaskininAdapter(Context context, int layout, ArrayList<TaskininList> lists) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TaskininList list = _lists.get(position);

        int button = list.getbutton();

        String resName1 = "@drawable/finish_btn_" + button;
